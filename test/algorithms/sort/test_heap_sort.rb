...
class TestHeapSort < Test::Unit::TestCase  
  ...
  def test_should_handle_array_with_one_element
    array = [1]
    Algorithms::Sort.heap_sort!(array)
  ...
  def test_build_heap_correctly_creates_maxheap
    ...
    Algorithms::Sort.build_max_heap(array)
    Algorithms::Sort.verify_maxheap(array, array.length, 0)
  end
